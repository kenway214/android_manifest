...
```
repo init -u https://github.com/kenway214/android_manifest -b bka
```
Alternateively, shallow clone everything to save a lot of space,
```
repo init --depth=1 -u https://github.com/kenway214/android_manifest -b bka
```

If you are a maintainer you need to use:
```
repo init -u https://github.com/kenway214/android_manifest -g all -b bka
```
Or to save space just as above :
```
repo init --depth=1 -u https://github.com/kenway214/android_manifest -g all -b bka
```
